...
sed \
  ...
  "${source_env}" > "${tmp_env}"
for key in SMART_BAMBOO_RELEASE_COMMIT SMART_BAMBOO_RELEASE_TAG SMART_BAMBOO_HUMAN_AUTH_ENABLED SMART_BAMBOO_AUTH_REQUIRE_HTTPS SMART_BAMBOO_TRUST_PROXY_HEADERS SMART_BAMBOO_SESSION_COOKIE_SECURE SMART_BAMBOO_TLS_ENABLED SMART_BAMBOO_TLS_CERT_PATH SMART_BAMBOO_TLS_KEY_PATH REMOTE_SENSING_API_TOKENS SMART_BAMBOO_BREAK_GLASS_TOKEN; do
