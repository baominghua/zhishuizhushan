...
def test_health_payload_exposes_core_api_deployment_checks(app_client):
    ...
    assert api_checks["dictionaries"]["path"] == "/api/dictionaries"
    assert api_checks["dictionaries"]["permission"] == "system.dictionaries.view"
    assert api_checks["dictionary_options"]["path"] == "/api/dictionary-options/{type_code}"
