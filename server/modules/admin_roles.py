...
PERMISSION_API_SCOPES = {
    ...
    "system.organizations.manage": [
        "/api/admin/organizations",
        "/api/admin/organizations/{organization_id}",
        "/api/admin/organizations/{organization_id}/restore",
    ],
    "system.organizations.create": ["/api/admin/organizations"],
    "system.organizations.update": ["/api/admin/organizations/{organization_id}"],
    "system.organizations.delete": ["/api/admin/organizations/{organization_id}"],
    "system.organizations.restore": ["/api/admin/organizations/{organization_id}/restore"],
    ...
    "imagery.scenes.view": [
        ...
        "/api/scenes/workflow-summary",
        "/api/scenes/operation-queue",
        "/api/scenes/{scene_id}/point-cloud/copc",
        "/api/scenes/{scene_id}/point-cloud/tiles/{asset_path}",
    ],
    "imagery.scenes.create": [
        "/api/scenes/upload",
        "/api/scenes/register",
        "/api/point-clouds/upload-sessions",
        "/api/point-clouds/upload-sessions/{session_id}",
...
EXTRA_PERMISSIONS = [
    ...
    {"code": "system.organizations.view", "label": "组织架构查看", "module": "organizationsV2"},
    {"code": "system.organizations.manage", "label": "组织架构全权管理", "module": "organizationsV2"},
    {"code": "system.organizations.create", "label": "组织新增", "module": "organizationsV2"},
    {"code": "system.organizations.update", "label": "组织编辑", "module": "organizationsV2"},
    {"code": "system.organizations.delete", "label": "组织删除", "module": "organizationsV2"},
    {"code": "system.organizations.restore", "label": "组织恢复", "module": "organizationsV2"},
...
MANAGE_PERMISSION_IMPLICATIONS = {
    ...
    "system.organizations.create": ["system.organizations.view"],
    "system.organizations.update": ["system.organizations.view"],
    "system.organizations.delete": ["system.organizations.view"],
    "system.organizations.restore": ["system.organizations.view"],
